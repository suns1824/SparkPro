package com.happy.spark.project.dao

import com.happy.spark.project.domain.{CourseClickCount, CourseSearchClickCount}
import com.happy.spark.project.utils.HBaseUtils
